...
class EnrollmentsControllerTest < ActionController::TestCase
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post :create, enrollment: { count: @enrollment.count, id_subject: @enrollment.id_subject, id_user: @enrollment.id_user }
    end
  ...
  test "should update enrollment" do
    patch :update, id: @enrollment, enrollment: { count: @enrollment.count, id_subject: @enrollment.id_subject, id_user: @enrollment.id_user }
    assert_redirected_to enrollment_path(assigns(:enrollment))
  end
